...
class Decode
{
   ...
   private:
      ...
      STATE state;
      FIT_UINT8 fileHdrOffset = 0;
      FIT_UINT8 fileHdrSize = 0;
      FIT_UINT32 fileDataSize = 0;
      FIT_UINT32 fileBytesLeft = 0;
      FIT_UINT16 crc = 0;
      Mesg mesg;
      FIT_UINT8 localMesgIndex = 0;
      MesgDefinition localMesgDefs[FIT_MAX_LOCAL_MESGS];
      FIT_UINT8 archs[FIT_MAX_LOCAL_MESGS];
      FIT_UINT8 numFields = 0;
      FIT_UINT8 fieldIndex = 0;
      FIT_UINT8 fieldDataIndex = 0;
      FIT_UINT8 fieldBytesLeft = 0;
      FIT_UINT8 fieldData[FIT_MAX_FIELD_SIZE];
      FIT_UINT8 lastTimeOffset = 0;
      FIT_UINT32 timestamp = 0;
